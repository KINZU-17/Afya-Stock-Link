...
export function getExpiryStatus(expiryDate) {
  ...
  if (daysLeft < 0) return { label: "⚠️ EXPIRED", color: "text-red-600 font-bold" };
  if (daysLeft <= 90) return { label: `⚠️ Expires in ${daysLeft} days`, color: "text-orange-600 font-semibold" };
